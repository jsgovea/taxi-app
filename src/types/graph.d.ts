...
export interface Mutation {
  SendMessageChat: SendMessageChatResponse;
...
export interface SendMessageChatMutationArgs {
  text: string;
  chatId: number;
}
